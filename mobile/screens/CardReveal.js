...
const CardReveal = ({ route }) => {
    ...
    return (
        <View style={
            ...
            />
            <TouchableOpacity style={stylesheet.btn} onPress={() => navigation.navigate("Chat", { backlog: backlog ,backlogs:backlogs,currentDocumentId:currentDocumentId, project:project, user:user})}>
